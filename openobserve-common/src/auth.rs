...
use openobserve_infra::config::{PASSWORD_HASH, USERS};
use openobserve_meta::user::UserRole;
...
mod tests {
    use super::*;
    use openobserve_meta::user::UserRequest;
    use openobserve_service::users;
    use openobserve_meta::organization::DEFAULT_ORG;
